...
export const initialQueries: MockQuery[] = [
  {
    ...
    fee: 5,
    createdAt: e1.stakes[0].timestamp - 24 * HOUR,
  ...
  },
  {
    ...
    fee: 6,
    createdAt: e2.stakes[0].timestamp - 12 * HOUR,
  ...
  },
  {
    ...
    outcomes: ['No', 'Yes', 'Invalid'],
    fee: 5,
    createdAt: e3.stakes[0].timestamp - 36 * HOUR,
    appealBond: 0,
    tentativeOutcome: 1,
    finalOutcome: 1,
  ...
  },
  {
    ...
    outcomes: ['No', 'Yes', 'Invalid'],
    fee: 6,
    createdAt: e5.stakes[0].timestamp - 48 * HOUR,
  ...
  },
  {
    ...
    outcomes: ['No', 'Yes', 'Invalid'],
    fee: 4,
    createdAt: e6.stakes[0].timestamp - 20 * HOUR,
  ...
  },
  {
    ...
    outcomes: ['No', 'Yes', 'Invalid'],
    fee: 9,
    createdAt: e13.stakes[0].timestamp - 34 * HOUR,
  ...
  },
  {
    ...
    outcomes: ['No', 'Yes', 'Invalid'],
    fee: 3,
    createdAt: e20.stakes[0].timestamp - 40 * HOUR,
    appealBond: 0,
    tentativeOutcome: 1,
    finalOutcome: 1,
  ...
  },
  {
    ...
    outcomes: ['No', 'Yes', 'Invalid'],
    fee: 2,
    createdAt: e21.stakes[0].timestamp - DAY,
    appealBond: 0,
    tentativeOutcome: 1,
    finalOutcome: 1,
  ...
  },
  {
    ...
    outcomes: ['No', 'Yes', 'Invalid'],
    fee: 2,
    createdAt: e22.stakes[0].timestamp - DAY,
    appealBond: 0,
    tentativeOutcome: 1,
    finalOutcome: 1,
